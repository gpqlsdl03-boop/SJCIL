        ...
        <div className="flex w-full max-w-md flex-col gap-8 rounded-3xl bg-white p-8 md:p-12 shadow-xl ring-1 ring-zinc-200">
          ...
          {error && (
            <div className="rounded-2xl bg-red-50 border border-red-200 p-4 text-sm text-red-800 leading-relaxed">
              ...
              <p>신세계중랑CIL 선생님이라면 기관 이메일로 로그인해주세요.</p>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-3">
            <input
              ...
              className="w-full rounded-2xl border-2 border-zinc-200 px-4 py-3.5 text-sm focus:outline-none focus:border-zinc-400"
            />
            <input
              type="password"
              required
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center justify-center w-full py-4 px-6 rounded-2xl bg-zinc-900 hover:bg-zinc-800 transition-all font-bold text-white text-base shadow-sm disabled:opacity-60 min-h-[56px]"
            >
              {loading ? "로그인 중..." : "로그인하기"}
            </button>
          </form>
          ...
          <div className="text-center text-sm text-zinc-500 leading-relaxed space-y-1">
            <p>선생님: 기관 이메일(il@sjcil.org)로 로그인해주세요</p>
